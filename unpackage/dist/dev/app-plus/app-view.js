...
var bIG=_mz(z,'navigator',['style',30,'url',1],[],aFG,lEG,gg)
var oJG=_mz(z,'view',['class',32,'style',1],[],aFG,lEG,gg)
_(bIG,oJG)
var xKG=_oz(z,34,aFG,lEG,gg)
_(bIG,xKG)
_(tGG,bIG)
return tGG
}
...
var oRG=_mz(z,'uni-collapse',['bind:__l',39,'vueId',1,'vueSlots',2],[],hOG,cNG,gg)
var lSG=_mz(z,'uni-collapse-item',['bind:__l',42,'showAnimation',1,'title',2,'vueId',3,'vueSlots',4],[],hOG,cNG,gg)
var aTG=_v()
_(lSG,aTG)
var tUG=function(bWG,eVG,oXG,gg){
var oZG=_mz(z,'navigator',['hidden',51,'style',1,'url',2],[],bWG,eVG,gg)
var f1G=_mz(z,'view',['class',54,'style',1],[],bWG,eVG,gg)
_(oZG,f1G)
var c2G=_oz(z,56,bWG,eVG,gg)
_(oZG,c2G)
_(oXG,oZG)
return oXG
}
aTG.wxXCkey=2
_2z(z,49,tUG,hOG,cNG,gg,aTG,'u_item','u_index','u_index')
_(oRG,lSG)
_(oPG,oRG)
return oPG
}
oLG.wxXCkey=4
_2z(z,37,fMG,e,s,gg,oLG,'item','index','index')
var h3G=_mz(z,'uni-drawer',['bind:__l',57,'bind:close',1,'data-event-opts',2,'mode',3,'style',4,'visible',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var o4G=_mz(z,'scroll-view',['class',65,'scrollY',1],[],e,s,gg)
var c5G=_v()
_(o4G,c5G)
var o6G=function(a8G,l7G,t9G,gg){
var bAH=_n('view')
_rz(z,bAH,'class',71,a8G,l7G,gg)
var oBH=_n('view')
_rz(z,oBH,'class',72,a8G,l7G,gg)
var xCH=_oz(z,73,a8G,l7G,gg)
_(oBH,xCH)
var oDH=_mz(z,'button',['bindtap',74,'class',1,'data-event-opts',2,'style',3],[],a8G,l7G,gg)
_(oBH,oDH)
var fEH=_mz(z,'button',['bindtap',78,'class',1,'data-event-opts',2,'style',3],[],a8G,l7G,gg)
_(oBH,fEH)
_(bAH,oBH)
_(t9G,bAH)
return t9G
...
c5G.wxXCkey=2
_2z(z,69,o6G,e,s,gg,c5G,'item','index','index')
_(h3G,o4G)
_(hWF,h3G)
var cFH=_mz(z,'uni-fab',['bind:__l',82,'bind:u_trigger',1,'class',2,'data-event-opts',3,'data-ref',4,'direction',5,'horizontal',6,'pattern',7,'vertical',8,'vueId',9],[],e,s,gg)
_(hWF,cFH)
var hGH=_n('view')
_rz(z,hGH,'class',92,e,s,gg)
var oHH=_n('view')
_rz(z,oHH,'class',93,e,s,gg)
var cIH=_n('view')
_rz(z,cIH,'class',94,e,s,gg)
var oJH=_mz(z,'view',['class',95,'style',1],[],e,s,gg)
var lKH=_oz(z,97,e,s,gg)
_(oJH,lKH)
_(cIH,oJH)
var aLH=_mz(z,'view',['bindtap',98,'class',1,'data-event-opts',2],[],e,s,gg)
var tMH=_n('text')
_rz(z,tMH,'class',101,e,s,gg)
_(aLH,tMH)
_(cIH,aLH)
_(oHH,cIH)
var eNH=_mz(z,'view',['class',102,'style',1],[],e,s,gg)
var bOH=_mz(z,'view',['class',104,'style',1],[],e,s,gg)
var oPH=_n('view')
_rz(z,oPH,'class',106,e,s,gg)
var xQH=_oz(z,107,e,s,gg)
_(oPH,xQH)
_(bOH,oPH)
var oRH=_mz(z,'input',['bindinput',108,'data-event-opts',1,'name',2,'value',3],[],e,s,gg)
_(bOH,oRH)
_(eNH,bOH)
_(oHH,eNH)
var fSH=_n('view')
...
var cTH=_n('view')
_rz(z,cTH,'class',113,e,s,gg)
var hUH=_mz(z,'button',['bindtap',114,'class',1,'data-event-opts',2],[],e,s,gg)
var oVH=_oz(z,117,e,s,gg)
_(hUH,oVH)
_(cTH,hUH)
var cWH=_mz(z,'button',['bindtap',118,'class',1,'data-event-opts',2],[],e,s,gg)
var oXH=_oz(z,121,e,s,gg)
_(cWH,oXH)
_(cTH,cWH)
_(fSH,cTH)
_(oHH,fSH)
...
_(hWF,hGH)
var lYH=_n('view')
_rz(z,lYH,'class',122,e,s,gg)
var aZH=_n('view')
_rz(z,aZH,'class',123,e,s,gg)
var t1H=_n('view')
_rz(z,t1H,'class',124,e,s,gg)
var e2H=_mz(z,'view',['class',125,'style',1],[],e,s,gg)
var b3H=_oz(z,127,e,s,gg)
_(e2H,b3H)
_(t1H,e2H)
var o4H=_mz(z,'view',['bindtap',128,'class',1,'data-event-opts',2],[],e,s,gg)
var x5H=_n('text')
_rz(z,x5H,'class',131,e,s,gg)
_(o4H,x5H)
_(t1H,o4H)
_(aZH,t1H)
var o6H=_mz(z,'view',['class',132,'style',1],[],e,s,gg)
var f7H=_mz(z,'view',['class',134,'style',1],[],e,s,gg)
var c8H=_n('view')
_rz(z,c8H,'class',136,e,s,gg)
var h9H=_oz(z,137,e,s,gg)
_(c8H,h9H)
_(f7H,c8H)
var o0H=_mz(z,'input',['bindinput',138,'data-event-opts',1,'name',2,'value',3],[],e,s,gg)
_(f7H,o0H)
_(o6H,f7H)
_(aZH,o6H)
var cAI=_n('view')
_rz(z,cAI,'class',142,e,s,gg)
var oBI=_n('view')
_rz(z,oBI,'class',143,e,s,gg)
var lCI=_mz(z,'button',['bindtap',144,'class',1,'data-event-opts',2],[],e,s,gg)
var aDI=_oz(z,147,e,s,gg)
_(lCI,aDI)
_(oBI,lCI)
var tEI=_mz(z,'button',['bindtap',148,'class',1,'data-event-opts',2],[],e,s,gg)
var eFI=_oz(z,151,e,s,gg)
_(tEI,eFI)
_(oBI,tEI)
_(cAI,oBI)
_(aZH,cAI)
